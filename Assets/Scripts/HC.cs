...
{
    public GameObject RSW;
    private static HC m_instance;
    private const int LeaderboardLength = 10;

    public static HC _instance
    {
        get
        {
            if (m_instance == null)
            {
                m_instance = new GameObject("HighScoreManager").AddComponent<HC>();
            }
            return m_instance;
        }
    }
