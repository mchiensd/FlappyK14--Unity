...
public class ScrollSnapRectC : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
{
    ...
    private void LerpToPage(int aPageIndex)
    {
        ...
        _lerp = true;
        _currentPage = aPageIndex;
        Debug.Log("Index Char: " + aPageIndex);
        StateIntC = aPageIndex;
    }
